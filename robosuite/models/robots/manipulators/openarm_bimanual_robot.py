...
class OpenArmBimanual(ManipulatorModel):
    """
    https://openarm.dev/
    ...
    def __init__(self, idn=0):
        super().__init__(xml_path_completion("robots/openarm_bimanual/robot.xml"), idn=idn)
    ...
    def default_gripper(self):
        ...
        """
        return {"right": "OpenArmGripper", "left": "OpenArmGripper"}
    ...
    def default_controller_config(self):
        ...
        """
        return {"right": "default_openarm", "left": "default_openarm"}
